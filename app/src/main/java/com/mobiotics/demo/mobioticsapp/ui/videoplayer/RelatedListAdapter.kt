...
class RelatedListAdapter(private val context: Context,
                         private val dataList: List<RetroVideo>) : RecyclerView.Adapter<RelatedListAdapter.CustomViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomViewHolder {
        ...
        val view = layoutInflater.inflate(R.layout.related_list_row, parent, false)
